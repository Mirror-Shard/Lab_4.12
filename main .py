...
class DateBase:
    def __init__(self, db_file) -> None:
        ...
        self.q.exec_(
            """INSERT INTO Ticket VALUES("8d2cbab4e5ec03c99215bb6cbf619348", "Москва", "Самара", "3:50")"""
        )
        self.q.exec_(
            """INSERT INTO Ticket VALUES("d7f1748981fe83e7e33d177e7ecd8e70", "Самара", "Вашингтон", "8:15")"""
        )
        self.q.exec_(
            """INSERT INTO Ticket VALUES("adbbc672f485dc806ca03d9e7287d192", "Тольятти", "Уфа", "2:45")"""
        )
        self.q.exec_(
            """INSERT INTO Passenger VALUES("0000000021", "Абрамов Андрей", "09.09.2000", "0719568675")"""
        )
        self.q.exec_(
            """INSERT INTO Passenger VALUES("0000000127", "Орлов Иван", "08.08.2001", "0399568675")"""
        )
        self.q.exec_(
            """INSERT INTO Passenger VALUES("0000001439", "Горностай Яна", "07.07.2002", "1999568675")"""
        )
        self.q.exec_(
            """INSERT INTO Driver VALUES("0000000021", "Ахмед", "29.12.2022", "Поезд")"""
        )
        self.q.exec_(
            """INSERT INTO Driver VALUES("0000000127", "Абдул-Хамид", "30.12.2022", "Самолёт")"""
        )
        self.q.exec_(
            """INSERT INTO Driver VALUES("0000001439", "Шамсудин", "1.12.2023", "Автобус")"""
        )
...
class TableView:
    ...
    def SetupUI(self):
        ...
        self.color = QLabel("Тип транспорта: ")
        ...
        self.vin = QLabel("Код билета: ")
        self.marka_line = QLineEdit()
        self.marka = QLabel("Пункт отправления: ")
        self.model_line = QLineEdit()
        self.models = QLabel("Пункт прибытия: ")
        self.docs_reg = QLabel("Дата отправления: ")
    ...
    def tableOwner(self):
        self.raw_model = QSqlTableModel()
        self.sqlquery = QSqlQuery()
        self.query = """SELECT * FROM Passenger"""
        self.sqlquery.exec_(self.query)
        self.raw_model.setQuery(self.sqlquery)
    ...
    def add_data(self):
        self.sqlquery = QSqlQuery()
        self.query = "INSERT INTO Ticket VALUES('{}', '{}', '{}', '{}')".format(self.marka_line.text(), self.vin_line.text(), self.marka_line.text(), self.color_line.text())
        self.sqlquery.exec_(self.query)
        self.query = "INSERT INTO Passenger VALUES('{}', '{}', '{}', '{}')".format(self.doc_num_line.text(), self.line_name.text(), self.dateb_line.text(), self.line_pasport.text())
        self.sqlquery.exec_(self.query)
        self.query = "INSERT INTO Driver VALUES('{}', '{}', '{}', '{}')".format(self.doc_num_line.text(), self.vin_line.text(), self.docs_reg_line.text(), self.cate_line.text())
        self.sqlquery.exec_(self.query)
        self.update()
        self.frame1.setVisible(True)
        self.frame2.setVisible(False)
